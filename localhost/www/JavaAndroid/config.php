...
$maintext="Добро пожаловать в гостевую книгу."; // Текст, выводящийся перед формой ввода сообщения
$adminemail="email@email.ru"; // Емайл админа
$sendmail="1"; // отсылать сообщения на Емайл админу
$antispam="1"; // АНТИСПАМ вкл1/вкл2/вкл3/вкл4/выкл - 1/2/3/4/0
