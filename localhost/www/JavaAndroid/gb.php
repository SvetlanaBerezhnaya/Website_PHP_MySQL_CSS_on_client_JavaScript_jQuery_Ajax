...
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :-))');\">$s1</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :-)');\">$s2</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :-P');\">$s3</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' 8-)');\">$s4</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :-(');\">$s5</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :-O');\">$s6</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' ;-)');\">$s7</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :roll:');\">$s8</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' :rf:');\">$s9</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' 8-(');\">$s10</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie(' `-(');\">$s11</a>
<a class='gb' href='javascript:%20x()' onclick=\"DoSmilie('[RB]  [/RB] ');\"><font color=red><B>RB</b></font></a>
</tr></td></table>
</td><td>
...
if ($liteurl=="1") {$dt[0]=eregi_replace("((https?|ftp)://[[:alnum:]_=/-]+(\\.[[:alnum:]_=/-]+)*(/[[:alnum:]+&._=/~%]*(\\?[[:alnum:]?+&;_=/%]*)?)?)", "<a class='gb' href='\\1' target='_blank'>\\1</a>", $dt[0]);}
