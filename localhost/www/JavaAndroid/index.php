...
$result = mysql_query("SELECT title,meta_d,meta_k,text FROM settings WHERE page='index' and lang='$lang'",$db);
...
<table width="885" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="main_border">
